	...
	<div class="container-fluid">
		...
		<form method="post" action="inscription" class="col-6">
           ...
           <div class="form-group">
           		...
           		<input type="text" class="form-control" placeholder="Entrer prénom" name="prenom" id="prenom" required />
           		<p id ="prenom-helper"></p>
           </div>
           <div class="form-group">
           		<label for="age">Age : </label>
           		<input type="text" class="form-control" placeholder="Entrer âge" name="age" id="age" required />
           		<p id ="age-helper"></p>
           </div>
